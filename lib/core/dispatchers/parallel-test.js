...
describe(__filename + "#", function () {
    ...
    it("dispatch a message against one entry", function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            bus = new mesh_1.ParallelBus([
                new callback_1.CallbackDispatcher(function (m) { return i++; })
            ]);
            bus.dispatch({});
            bus.dispatch({});
            bus.dispatch({});
    ...
    it("dispatches a message against multiple dispatchers", function () { return __awaiter(_this, void 0, void 0, function () {
        var i, bus, _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    _a.apply(void 0, [_c.sent()]).to.eql([0, 1, 2]);
                    return [2 /*return*/];
            }
        });
    }); });
    it("Can handle a dispatcher that returns a rejection", function () { return __awaiter(_this, void 0, void 0, function () {
        var i, bus, error, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    bus = new mesh_1.ParallelBus([
                        new callback_1.CallbackDispatcher(function (m) { return i++; }),
                        new callback_1.CallbackDispatcher(function (m) { return Promise.reject(new Error("some error")); })
                    ]);
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
    ...
    it("Can cancel a request", function () { return __awaiter(_this, void 0, void 0, function () {
        var i, bus, readable, reader, _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    i = 0;
                ...
                case 1:
                    _a.apply(void 0, [_c.sent()]).to.eql({ value: 0, done: false });
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    return [4 /*yield*/, mesh_1.readAllChunks(bus.dispatch({}).readable)];
                case 1:
                    _a.apply(void 0, [_c.sent()]).to.eql([3, 0, 1, 2]);
                    return [2 /*return*/];
            }
        });
    }); });
    it("can write & read transformed data to a request", function () { return __awaiter(_this, void 0, void 0, function () {
        var bus, _a, writable, readable, writer, _b, _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    bus = new mesh_1.ParallelBus([
                        new callback_1.CallbackDispatcher(function (m) { return new mesh_1.DuplexStream(function (input, output) {
                ...
                case 4:
                    _b.apply(void 0, [_d.sent()]).to.eql([1, 0, 2, 1, 0]);
                    return [2 /*return*/];
            }
        });
    }); });
