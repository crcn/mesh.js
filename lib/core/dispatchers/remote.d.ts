...
export declare class RemoteBus<T> implements IBus<T>, IMessageTester<T> {
    private _localDispatcher;
    private _serializer;
    private _uid;
    private _proxy;
    private _family;
    ...
    constructor({adapter, family, testMessage}: IRemoteBusOptions, _localDispatcher?: IDispatcher<T, any>, _serializer?: any);
