...
var RemoteBus = (function () {
    function RemoteBus(_a, _localBus, _serializer) {
        var adapter = _a.adapter, family = _a.family, testMessage = _a.testMessage;
        if (_localBus === void 0) { _localBus = noop_1.noopBusInstance; }
        ...
        this._proxy = new proxy_1.ProxyBus(new callback_1.CallbackBus(this._dispatchRemoteMessage.bind(this)));
        this._proxy.pause();
    ...
    RemoteBus.prototype.onDispatch = function (_a) {
        ...
        var targetBus = this._shouldHandleMessage(payload) ? this._localBus : noop_1.noopBusInstance;
        ...
        var _b = streams_1.wrapDuplexStream(targetBus.dispatch(payload)), readable = _b.readable, writable = _b.writable;
